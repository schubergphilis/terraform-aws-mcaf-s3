...
* feat!: Add region support (#71) @shoekstra

#### 📖 Documentation

* docs: Upgrading to v2 (#72) @shoekstra

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-s3/compare/v1.5.2...v2.0.0
...
* fix: optional bucket_key_encryption_policy_enforced (#69) @fatbasstard

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-s3/compare/v1.5.1...v1.5.2
...
* fix: adding a toggle to enforce usage of the default bucket encryptio… (#68) @macampo

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-s3/compare/v1.5.0...v1.5.1
