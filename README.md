...
| <a name="input_logging"></a> [logging](#input\_logging) | n/a | <pre>object({<br>    target_bucket = string<br>    target_prefix = string<br>    target_object_key_format = optional(object({<br>      format_type           = string                        # "simple" or "partitioned"<br>      partition_date_source = optional(string, "EventTime") # Required if format_type is "partitioned"<br>    }))<br>  })</pre> | `null` | no |
