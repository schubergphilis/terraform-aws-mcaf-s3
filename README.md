...
| <a name="input_malware_protection"></a> [malware\_protection](#input\_malware\_protection) | Bucket malware protection settings | <pre>object({<br/>    enabled         = optional(bool, false)<br/>    object_prefixes = optional(list(string), null)<br/>  })</pre> | `{}` | no |
...
| <a name="input_permissions_boundary"></a> [permissions\_boundary](#input\_permissions\_boundary) | The ARN of the policy that is used to set the permissions boundary for the bucket. | `string` | `null` | no |
